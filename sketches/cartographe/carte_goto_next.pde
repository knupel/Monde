...
*/
// vec3 goto_next(R_Lithos grid[], R_Urbanist urb, vec6 canvas, ArrayList<R_Node> inter_list, ArrayList<R_Line2D> seg_list) {
...
// 	//
// 	//
// 	vec2 compute_plan_pos = compute_pos_2D(grid, urb, canvas, inter_list, seg_list);
...
// vec2 compute_pos_2D(R_Lithos grid[], R_Urbanist urb, vec6 canvas, ArrayList<R_Node> inter_list, ArrayList<R_Line2D> seg_list) {
// 	//
// 	//
// 	// c'est dans compute_pos_2D() qu'on doit faire la détection de l'altitude
...
// 	buf_pos = compute_pos_2D_out_canvas(grid, urb, canvas, inter_list, seg_list, buf_pos);
// 	// the function below create recursivity
// 	buf_pos = compute_pos_2D_no_cross(grid, urb, canvas, inter_list, seg_list, buf_pos);
...
// vec2 compute_pos_2D_out_canvas(R_Lithos grid[], R_Urbanist urb, vec6 canvas, ArrayList<R_Node> inter_list, ArrayList<R_Line2D> seg_list, vec2 pos) {
...
// 		pos = compute_pos_2D(grid, urb,canvas,inter_list, seg_list); 
...
// vec2 compute_pos_2D_no_cross(R_Lithos grid[], R_Urbanist urb, vec6 canvas, ArrayList<R_Node> inter_list, ArrayList<R_Line2D> seg_list, vec2 pos) {
// 	// limit for the recursive call
